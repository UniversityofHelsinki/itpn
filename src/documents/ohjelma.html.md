...
Suomen korkeakoulukentällä yhteistyömalleja on kokeiltu ja suunnitteilla yrityksistä osuuskuntaan ja konsortiosta kahdenvälisiin sopimuksiin. Minkälaiset mallit ovat tulevaisuutta, mikä ei ainakaan toimi ja miksi yhteistyökuviot ovat osottautuneet haasteellisiksikin? Tule mukaan keskusteluun paremmasta huomisesta!
				</div>
				<div class="speaker">Ilkka Siissalo, HY (pj), Pekka Kähkipuro, Aalto yliopisto, Tommi Kangasaho, Lahden ammattikorkeakoulu
				</div>
...
<div class="speaker">Laura Pesola ja Pekka Rundgren, Helsingin yliopisto</div>
				...
				<ul>
					<li>EXAM tenttityökalu on rakennettu yhteistyössä kymmenen korkeakoulun kanssa. </li>
